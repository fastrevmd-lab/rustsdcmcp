...
assert_build_info_key_contract() {
    local fixture
    fixture=$(mktemp)
    printf '%s\n' 'mecmcp_ref=v0.19.0' >"$fixture"
    has_single_exact_key mecmcp_ref 'mecmcp_ref=v0.19.0' "$fixture" \
        || fail 'singular expected BUILD-INFO mecmcp key was rejected'
    printf '%s\n' 'mecmcp_ref=v0.7.3' >>"$fixture"
    if has_single_exact_key mecmcp_ref 'mecmcp_ref=v0.19.0' "$fixture"; then
...
assert_exact_mecmcp_sbom_set() {
    ...
    valid=$(jq -nc '{
        ...
        components: [
            ...
            {name: "mecmcp-audit", version: "0.19.0"},
            {name: "mecmcp-auth", version: "0.19.0"},
            {name: "mecmcp-changeset", version: "0.19.0"},
            {name: "mecmcp-runtime", version: "0.19.0"},
            {name: "mecmcp-secret", version: "0.19.0"},
            {name: "mecmcp-server", version: "0.19.0"},
            {name: "mecmcp-transport", version: "0.19.0"}
        ]
    }')
...
[[ ${#builder_mecmcp_refs[@]} -eq 1 && ${builder_mecmcp_refs[0]} == 'v0.19.0' ]] \
...
require_logical_line \
    "has_single_exact_key mecmcp_ref 'mecmcp_ref=v0.19.0' \"\$build_info\" || die 'BUILD-INFO mecmcp ref is invalid'" \
    "$installer"
require_logical_line \
    "has_single_exact_key mecmcp_ref 'mecmcp_ref=v0.19.0' \"\$build_info\" || {" \
