...
assert_build_info_key_contract() {
    local fixture
    fixture=$(mktemp)
    printf '%s\n' 'mecmcp_ref=v0.21.0' >"$fixture"
    has_single_exact_key mecmcp_ref 'mecmcp_ref=v0.21.0' "$fixture" \
        || fail 'singular expected BUILD-INFO mecmcp key was rejected'
    printf '%s\n' 'mecmcp_ref=v0.7.3' >>"$fixture"
    if has_single_exact_key mecmcp_ref 'mecmcp_ref=v0.21.0' "$fixture"; then
...
assert_exact_mecmcp_sbom_set() {
    ...
    valid=$(jq -nc '{
        ...
        components: [
            ...
            {name: "mecmcp-audit", version: "0.21.0"},
            {name: "mecmcp-auth", version: "0.21.0"},
            {name: "mecmcp-changeset", version: "0.21.0"},
            {name: "mecmcp-runtime", version: "0.21.0"},
            {name: "mecmcp-secret", version: "0.21.0"},
            {name: "mecmcp-server", version: "0.21.0"},
            {name: "mecmcp-transport", version: "0.21.0"}
        ]
    }')
...
require_logical_line \
    ...
    "$installer"
require_logical_line \
    "has_single_exact_key mecmcp_ref 'mecmcp_ref=v0.21.0' \"\$build_info\" || {" \
...
required_mecmcp_pairs=(
    '["mecmcp-audit", "0.21.0"],'
    '["mecmcp-auth", "0.21.0"],'
    '["mecmcp-changeset", "0.21.0"],'
    '["mecmcp-runtime", "0.21.0"],'
    '["mecmcp-secret", "0.21.0"],'
    '["mecmcp-server", "0.21.0"],'
    '["mecmcp-transport", "0.21.0"]'
)
