...
assert_exact_mecmcp_sbom_set() {
    ...
    valid=$(jq -nc '{
        ...
        components: [
            ...
            {name: "mecmcp-audit", version: "0.11.0"},
            {name: "mecmcp-auth", version: "0.11.0"},
            {name: "mecmcp-changeset", version: "0.11.0"},
            {name: "mecmcp-runtime", version: "0.11.0"},
            {name: "mecmcp-secret", version: "0.11.0"},
            {name: "mecmcp-server", version: "0.11.0"},
            {name: "mecmcp-transport", version: "0.11.0"}
        ]
    }')
